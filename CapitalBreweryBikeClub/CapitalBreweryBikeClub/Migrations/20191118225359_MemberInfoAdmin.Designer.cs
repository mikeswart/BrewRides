...
namespace CapitalBreweryBikeClub.Migrations
{
    ...
    [Migration("20191118225359_MemberInfoAdmin")]
    partial class MemberInfoAdmin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CapitalBreweryBikeClub.Model.ScheduleData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("RouteDataRideWithGpsId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("RouteDataRideWithGpsId");
            ...
            modelBuilder.Entity("CapitalBreweryBikeClub.Model.ScheduleData", b =>
                {
                    b.HasOne("CapitalBreweryBikeClub.Model.RouteData", "RouteData")
                        .WithMany()
                        .HasForeignKey("RouteDataRideWithGpsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
